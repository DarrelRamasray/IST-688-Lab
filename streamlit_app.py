...
lab4_page = st.Page("Lab4.py", title="Lab 4", icon=":material/description:", default=True)  #Default page

pg = st.navigation([lab4_page,lab3_page,lab2_page, lab1_page])  #Lab4 listed first so it appears at the top of the sidebar
